...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="wa-float fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-elegant transition-transform hover:scale-110"
    ...
    >
      ...
      <style>{`
        @media (max-width: 768px) {
          .wa-float {
            animation: waGoldPulse 3s ease-in-out infinite;
          }
        }
        @keyframes waGoldPulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(196,149,58,0.55), 0 20px 40px -10px rgba(0,0,0,0.6); }
          50% { box-shadow: 0 0 0 16px rgba(196,149,58,0), 0 20px 40px -10px rgba(0,0,0,0.6); }
        }
      `}</style>
    </a>
  );
