...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="wa-float fixed bottom-6 right-6 z-40 hidden md:flex h-14 w-14 items-center justify-center rounded-full text-white transition-all duration-500 hover:scale-110 hover:-translate-y-1"
      style={{ 
