...
export function FinalCta() {
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden px-5 sm:px-6">
      <div className="mx-auto max-w-7xl">
        <div className="relative rounded-[3.5rem] bg-[#0a142e] p-10 sm:p-20 text-center border border-white/5 shadow-elegant overflow-hidden reveal">
          {/* Ambient glow */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.05] silver-text">
            ...
            <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-6">
              <a
                ...
                rel="noreferrer"
                id="final-cta-button"
                className="btn-silver w-full sm:w-auto inline-flex items-center justify-center gap-3 rounded-full bg-white px-12 py-5.5 text-sm font-semibold tracking-wide text-background shadow-silver transition-all duration-700"
              >
